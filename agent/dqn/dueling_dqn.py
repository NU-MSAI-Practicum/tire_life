...
class DuelingDQN(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.advantage_fc2 = nn.Linear(128, output_dim)
...
class DQNAgent:
    def __init__(self, state_dim, action_dims, gamma=0.99, lr=0.001, batch_size=64, memory_capacity=10000, device='cpu'):
        ...
        self.policy_net = DuelingDQN(state_dim, self.calculate_output_dim(action_dims)).to(self.device)
        self.target_net = DuelingDQN(state_dim, self.calculate_output_dim(action_dims)).to(self.device)
        ...
        self.learning_rate_scheduler = optim.lr_scheduler.StepLR(self.optimizer, step_size=1000, gamma=0.9)
